...
class JPush {
  ...
  static final JPush _instance = new JPush.private(const MethodChannel('jpush'));
  ...
  void setChannelAndSound({
    ...
    _channel.invokeMethod('setChannelAndSound', {'channel': channel, 'channel_id': channelID, 'sound': sound});
  }
  ...
  Future<dynamic> _handleMethod(MethodCall call) async {
    ...
    switch (call.method) {
      case "onReceiveNotification":
        return _onReceiveNotification!(call.arguments as Map<String, dynamic>);
      case "onOpenNotification":
        return _onOpenNotification!(call.arguments as Map<String, dynamic>);
      case "onReceiveMessage":
        return _onReceiveMessage!(call.arguments as Map<String, dynamic>);
      case "onReceiveNotificationAuthorization":
        return _onReceiveNotificationAuthorization!(call.arguments as Map<String, dynamic>);
      case "onNotifyMessageUnShow":
        return _onNotifyMessageUnShow!(call.arguments as Map<String, dynamic>);
      case "onConnected":
        return _onConnected!(call.arguments as Map<String, dynamic>);
      case "onInAppMessageClick":
        return _onInAppMessageClick!(call.arguments as Map<String, dynamic>);
      case "onInAppMessageShow":
        return _onInAppMessageShow!(call.arguments as Map<String, dynamic>);
      default:
  ...
  Future<Map<dynamic, dynamic>> setTags(List<String> tags) async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('setTags', tags);
      if (result is Map<dynamic, dynamic>) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
      }
    } catch (e) {
  ...
  Future<Map<dynamic, dynamic>> cleanTags() async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('cleanTags');
      if (result is Map<dynamic, dynamic>) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
  ...
  Future<Map<dynamic, dynamic>> addTags(List<String> tags) async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('addTags', tags);
      if (result is Map<dynamic, dynamic>) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
  ...
  Future<Map<dynamic, dynamic>> deleteTags(List<String> tags) async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('deleteTags', tags);
      if (result is Map<dynamic, dynamic>) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
  ...
  Future<Map<dynamic, dynamic>> getAllTags() async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('getAllTags');
      if (result is Map<dynamic, dynamic>) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
  ...
  Future<Map<dynamic, dynamic>> getAlias() async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('getAlias');
      if (result is Map<dynamic, dynamic>) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
  ...
  Future<Map<dynamic, dynamic>> setAlias(String alias) async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('setAlias', alias);
      if (result is Map<dynamic, dynamic>) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
  ...
  Future<Map<dynamic, dynamic>> deleteAlias() async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('deleteAlias');
      if (result is Map<dynamic, dynamic>) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
  ...
  Future<Map<dynamic, dynamic>> getLaunchAppNotification() async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('getLaunchAppNotification');
      if (result is Map<dynamic, dynamic>) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
  ...
  Future<String> getRegistrationID() async {
    ...
    try {
      final dynamic result = await _channel.invokeMethod('getRegistrationID');
      if (result is String) {
        return result;
      } else {
        throw Exception('Unexpected result type from platform method');
  ...
  Future<bool> isNotificationEnabled() async {
    try {
      final dynamic result = await _channel.invokeMethod('isNotificationEnabled');
      if (result is Map<dynamic, dynamic>) {
        bool isEnabled = result["isEnabled"] as bool;
        return isEnabled;
      } else {
        throw Exception('Unexpected result type from platform method');
      }
...
class LocalNotification {
  ...
  const LocalNotification({@required this.id, @required this.title, @required this.content, @required this.fireTime, this.buildId, this.extra, this.badge = 0, this.soundName, this.subtitle})
      : assert(id != null),
        assert(title != null),
        assert(content != null),
